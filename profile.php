...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">eic_three@thapar.edu</a>
        <i class="fa fa-phone"></i> 9868011289
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto">Travel<span>Wingman</span></a></h1>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2>Explore<br> India</h2>
      <div>
        <a href="registration/bussearch.php" class="btn-get-started scrollto">Book Ticket</a>
      </div>
    </div>
  ...
  <main id="main">
     ...
     <section id="Partners" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Partners</h2>
          <p>With the Help of our partners we make your travel memorable</p>
        </div>
    ...
    <section id="about" class="wow fadeInUp">
      <div class="container">
        <div class="row">
        <p> We are a Patiala based Travel Agency.<br>
          It will be our pleasure for us to help you realise your dream for India Tour.
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>doopieLTD</strong>. All Rights Reserved
      </div>
      <div class="credits">
        
      Designed by Arya Shukla - 102105048 <br>Anoop Krishna Rastogi - 102105050<br>Saatwik Choudhary - 102105059<br>Prachi Bajetha - 102105061</a>
      </div>
    </div>
  </footer><!-- #footer -->
